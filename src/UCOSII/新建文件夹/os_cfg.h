...
#define OS_MAX_EVENTS            15//10    /* Max. number of event control blocks in your application      */
...
#define OS_MAX_QS                10// 4    /* Max. number of queue control blocks in your application      */
